...
import '../../../data/blocs/allCategories_bloc/all_categories_bloc.dart';
                ...
                onTap: () {
                  Navigator.pushNamed(
                    ...
                    arguments: DetailPageModel(
                      state.allCategoriesModel.articles?[index].author,
                      state.allCategoriesModel.articles![index].urlToImage,
                      'All',
                      state.allCategoriesModel.articles?[index].title,
                      state.allCategoriesModel.articles![index].content,
                    ),
                  );
                },
                child: SizedBox(
                              ...
                              SizedBox(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      state.allCategoriesModel.articles?[index]
                                              .source?.name ??
                                          'Uch savdoyi',
                                      maxLines: 1,
