                ...
                onTap: () {
                  Navigator.pushNamed(
                    ...
                    arguments: DetailPageModel(
                      state.categoriesModel.articles![index].source?.name,
                      state.categoriesModel.articles![index].urlToImage,
                      category,
                      state.categoriesModel.articles![index].title,
                      state.categoriesModel.articles?[index].content,
                    ),
                  );
                },
                child: SizedBox(
                              ...
                              SizedBox(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    Text(
                                      state.categoriesModel.articles?[index]
                                              .source?.name ??
                                          'Uch savdoyi',
                                      maxLines: 1,
                                      overflow: TextOverflow.ellipsis,
